...
public class Account {
    ...
    /**
     * A default, no-args constructor, as well as correctly formatted getters and
     * setters, are needed for
    ...
    /**
     * When posting a new Account, the id can be generated by the database. In that
    ...
    /**
     * Whem retrieving an Account from the database, all fields will be needed. In
     * that case, a constructor with all
     * fields is needed.
     * 
     * @param account_id
     * @param username
    ...
    /**
     * Properly named getters and setters are necessary for Jackson ObjectMapper to
     * work. You may use them as well.
     * 
     * @return account_id
     */
    ...
    /**
     * Overriding the default equals() method adds functionality to tell when two
